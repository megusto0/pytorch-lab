...
> Лабораторная работа по дисциплине, связанной с применением искусственного интеллекта в анализе данных и управлении.
...
**03 — Регрессия на PyTorch.** Выполняется полный цикл обучения регрессионной модели на датасете Auto MPG: загрузка данных из UCI, очистка, кодирование категориального признака, стандартизация, `DataLoader`, обучение MLP и оценка RMSE.
